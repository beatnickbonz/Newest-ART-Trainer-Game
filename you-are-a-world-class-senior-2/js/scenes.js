...
class GameScene extends Phaser.Scene {
  ...
  onZoneClick(assignment) {
    ...
    if (assignment === "emptyTrailer") return this.sim.staging.requestEmptyPalletRestock();
    if (assignment === "raaPrimary") return this.sim.staging.requestRaaPrep("primary");
    if (assignment === "raaSecondary") return this.sim.staging.requestRaaPrep("secondary");
    this.sim.workers.assignSelected(assignment);
  }
  togglePause() {
